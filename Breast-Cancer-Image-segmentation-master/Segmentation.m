function [N_objects,N_holes,AvgEccent_objs,Euler,Arnf1,eccnmedian,eccnmean,eccnvar, eccnkurtosis,eccnskew]=Segmentation(IM, n)
m=n;
%im=imread(fname);
im=mat2gray(IM);
...
saveas(h,sprintf('change%d.png',m));
%m=m+1;
